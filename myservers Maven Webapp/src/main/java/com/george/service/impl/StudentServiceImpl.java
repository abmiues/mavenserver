...
public class StudentServiceImpl implements StudentService {  
	...
	@Override
	public ArrayList<Infor> stu_getinfolist(String stuid) {
		return studentdao.stu_getinfolist(stuid);
		
	}
	@Override
	public Infor stu_getinfo(int id) {
		 return studentdao.stu_getinfo(id);
	}
