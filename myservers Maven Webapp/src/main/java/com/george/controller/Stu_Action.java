...
public class Stu_Action {
	...
	//[end]
	@RequestMapping(value="/stu_getinfolist",method=RequestMethod.GET)
	public @ResponseBody
	ArrayList<Infor> getinfolist(@RequestParam(value="stuid")String stuid,
			HttpServletRequest request)
	{
		return studentService.stu_getinfolist(stuid);
	}
	
	@RequestMapping(value="/stu_getinfo",method=RequestMethod.GET)
	public @ResponseBody
	Infor getinfo(@RequestParam(value="id")int id,HttpServletRequest request)
	{
		return studentService.stu_getinfo(id);
	}
